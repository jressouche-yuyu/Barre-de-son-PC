...
## USB-C : le choix par défaut sur PC
...
La prise jack reste le plus petit dénominateur commun : elle fonctionne partout. Mais le signal est **analogique**, donc sensible aux parasites de la carte son et des câbles. Pratique en dépannage ou sur un portable, moins idéale comme solution principale.
...
| Connexion | Idéal pour | Limite |
|---|---|---|
| **USB-C** | Usage PC quotidien, gaming | Câble |
| **Jack 3,5 mm** | Dépannage, portables | Signal analogique |
