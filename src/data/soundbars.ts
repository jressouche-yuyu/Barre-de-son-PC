...
const saisie: SoundbarInput[] = [
  ...
  },
  {
    ...
    summary:
      'Pensée pour le PC, la Leviathan V2 associe deux haut-parleurs large bande, deux tweeters, deux radiateurs passifs et un caisson 14 cm à émission vers le bas (45 Hz – 20 kHz ; Razer ne publie pas de puissance). Branchée en USB, elle offre un rendu dynamique, du THX Spatial Audio et un éclairage Chroma RGB sur 18 zones, le tout dans un format compact.',
    pros: [
  ...
  },
  {
    ...
    summary:
      'La V2X reprend la formule tri-amplifiée de la Katana V2 dans un format plus contenu : 2 médiums 63 mm, 2 tweeters 19 mm et un caisson 13,3 cm plus compact, pour 90 W RMS (180 W crête). La connectique reste très riche (USB, Bluetooth, optique, HDMI ARC, AUX) et le Super X-Fi est de la partie. Un excellent compromis.',
    pros: [
    ...
    connectivity: ['USB-C', 'Bluetooth', 'Jack 3.5mm', 'Optique', 'HDMI ARC'],
    driverConfig: '2 médiums 63 mm + 2 tweeters 19 mm + caisson 13,3 cm (tri-amplifié)',
    powerRmsWatts: 90,
    powerPeakWatts: 180,
    frequencyResponse: '50 Hz – 20 kHz',
    hasSubwoofer: true,
    hasMicrophone: true,
    hasRGB: true,
    dimensionsCm: { width: 60, height: 6, depth: 9.5 },
  ...
  },
  {
    ...
    hasMicrophone: false,
    hasRGB: true,
    dimensionsCm: { width: 40, height: 7.7, depth: 7.1 },
  ...
  },
  {
    ...
    hasMicrophone: false,
    hasRGB: false,
    dimensionsCm: { width: 41, height: 9.4, depth: 7.5 },
  ...
  },
  {
    ...
    hasMicrophone: false,
    hasRGB: false,
    dimensionsCm: { width: 56.5, height: 8.8, depth: 7.5 },
  ...
  },
  {
    ...
    hasMicrophone: true,
    hasRGB: true,
    dimensionsCm: { width: 48.5, height: 7, depth: 8 },
  ...
  },
  {
    ...
    hasMicrophone: false,
    hasRGB: true,
    dimensionsCm: { width: 10.4, height: 16.8, depth: 11.5 },
